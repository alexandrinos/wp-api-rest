...
class Magee_Section {
	...
	function render( $args, $content = '') {
        ...
        $html    = sprintf('%s<section class="section magee-section %s" id="%s"><div class="section-content %s">%s</div>%s %s</section>',$styles,esc_attr($class),esc_attr($id),$container,$content,$top_separator_html,$bottom_separator_html);
